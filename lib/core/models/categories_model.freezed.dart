...
abstract class $CategoriesModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, double width});
}
...
class _$CategoriesModelImpl extends _CategoriesModel {
  const _$CategoriesModelImpl({required this.name, required this.width})
      : super._();
  ...
  @override
  String toString() {
    return 'CategoriesModel(name: $name, width: $width)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, width);
...
abstract class _CategoriesModel extends CategoriesModel {
  const factory _CategoriesModel(
      ...
      required final double width}) = _$CategoriesModelImpl;
